...
@SpringBootTest
public class ModifyDubboReferenceActionTest_Springboot {
  ...
  public void testModifyDubboReferenceActionTest() throws Exception {
    modifyDubboReferenceAction.run(TEMP_DIR_PATH + fileSeparator + "dubbo-springboot");
    ...
    String tempCommonPath = TEMP_DIR_PATH + fileSeparator + "dubbo-springboot" + fileSeparator +
        "consumer" + fileSeparator + "src" + fileSeparator + "main" + fileSeparator + "java" + fileSeparator +
